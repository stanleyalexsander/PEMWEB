...
<head>
    ...
    <title>Works - DMSlib - Portofolio of Stanley Alexsander Tamboto - Fullstack Developer</title>
...
<body>
    ...
    <!-- HERO -->
    <div class="container-fluid cover bg-dmslib text-prim">
        <div class="row marquee-row m-0">
        ...
        <div class="row wrap-padding m-0">
    ...
    <div class="container-fluid container-content text-prim">
        <div class="row m-0">
            ...
            <div class="col-12" data-aos="fade-up" data-as-duration="1000">
                <img src="../img/img_dmslib1.png" class="h-100" alt="DMSlib website design overview">
            </div>
            <div class="col-12" data-aos="fade-up" data-aos-duration="1000">
                <img src="../img/img_dmslib2.png" class="h-100" alt="DMSlib website design overview">
            </div>
        </div>
    </div>
    <!-- END CONTENT -->
