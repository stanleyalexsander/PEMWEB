...
<head>
    ...
    <title>Works - SMKS Nusantara - Portofolio of Stanley Alexsander Tamboto - Fullstack Developer</title>
...
<body>
    ...
    $sqlProject = "SELECT * FROM project WHERE id = 3";
    ...
    <!-- HERO -->
    <div class="container-fluid cover bg-plkm text-prim">
    ...
    <div class="container-fluid container-content text-prim">
        <div class="row m-0">
            ...
            <div class="col-12" data-aos="fade-up" data-aos-duration="1000">
                <img src="../img/img_nusan1.png" class="h-100" alt="SMKS Nusantara website design overview">
            </div>
            <div class="col-12" data-aos="fade-up" data-aos-duration="1000">
                <img src="../img/img_nusan2.png" class="h-100" alt="SMKS Nusantara website design overview">
            </div>
        </div>
    </div>
    <!-- END CONTENT -->
